---
title: "Logistic Regression -- Counting and Classification"
...
We focus on the two most common types of count models: the binomial and the Poisson.
...
$$logit(p_i) = \alpha + \beta_i\text{time}$$
...
mod1.0 <- brm(
  formula = positive | trials(tested) ~ end_date,
  data = covid,
  family = binomial(),
  prior = priors,
  chains = 3,
  file = here("models/positive|trials(tested)~1_prior_only"),
  sample_prior = "only",
