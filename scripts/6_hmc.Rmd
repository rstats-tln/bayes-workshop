...
```{r}
mcmc_parcoord(as.array(m), np = nuts_params(m), pars = c("b_Intercept", "b_age", "sigma"), regex_pars = "county") + xaxis_text(angle = 90, hjust = 1, vjust = 0.5)
```
...
```{r}
mcmc_parcoord(as.array(m10), np = nuts_params(m10), pars = c("b_Intercept", "b_age", "sigma"), regex_pars = "county") + xaxis_text(angle = 90, hjust = 1, vjust = 0.5)
```
