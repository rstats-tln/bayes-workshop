...
```{r}
m_demementia_normal <- brm(postacute_therapy~dementia, data=d, file="models/m_demementia_normal")
m_demementia_lognormal <- brm(postacute_therapy~dementia, data=d, family = lognormal(), file="models/m_demementia_lognormal")
m_demementia_student <- brm(postacute_therapy~dementia, data=d, family = student(), file="models/m_demementia_student")
m_demementia_normal_log <- brm(log(postacute_therapy)~dementia, data=d, file="models/m_demementia_normal_log")

m_demementia_normal <- add_criterion(m_demementia_normal, "loo", file="models/m_demementia_normal")
m_demementia_lognormal <- add_criterion(m_demementia_lognormal, "loo", file="models/m_demementia_lognormal")
m_demementia_student <- add_criterion(m_demementia_student, "loo", file="models/m_demementia_student")
...
```{r}
m_demementia_student_s <- brm(bf(postacute_therapy~dementia, sigma~dementia), data=d, family = student(), file="models/m_demementia_student_s")
